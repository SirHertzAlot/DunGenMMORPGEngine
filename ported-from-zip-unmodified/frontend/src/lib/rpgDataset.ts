...
import {
  FANTASY_RIVALS_ENEMY_NAMES,
  FANTASY_RIVALS_MODEL_NAMES,
  FANTASY_RIVALS_WEAPON_DEFINITIONS,
} from './fantasyRivalsDataset';

export * from './fantasyRivalsDataset';
...
export class RPGDatasetService {
  ...
  static initialize(): void {
    debugLogger.info('rpg-dataset', 'RPG Dataset initialized', {
      ...
      fantasyRivalsModelNames: FANTASY_RIVALS_MODEL_NAMES.length,
      fantasyRivalsWeaponDefinitions: FANTASY_RIVALS_WEAPON_DEFINITIONS.length,
      fantasyRivalsEnemyNames: FANTASY_RIVALS_ENEMY_NAMES.length,
    });
  }
}
