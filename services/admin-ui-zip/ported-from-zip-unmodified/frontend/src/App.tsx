...
import RuntimeSystem from './pages/RuntimeSystem';
import ModelStudioPage from './pages/ModelStudioPage';
import DiagnosticLogsPage from './pages/DiagnosticLogsPage';
...
const diagnosticLogsRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: '/diagnostic-logs',
  component: DiagnosticLogsPage,
});

const modelStudioRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: '/model-studio',
