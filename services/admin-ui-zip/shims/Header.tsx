...
import { Activity, Bot, Bug, Grid3x3, LayoutDashboard, Menu, FolderOpen, LogIn, LogOut, User, Swords, Eye, FileCode, Database } from 'lucide-react';
...
export default function Header() {
  ...
  const handleDiagnosticLogsClick = () => {
    ...
    <header className="border-b border-border bg-card">
      <div className="container mx-auto flex h-14 items-center justify-between px-4 sm:h-16 sm:px-6">
        ...
        <nav className="hidden items-center gap-2 lg:flex">
          ...
          <Button
            variant={currentPath === '/observability' ? 'default' : 'ghost'}
            size="sm"
          ...
          <Button
            variant={currentPath === '/diagnostic-logs' ? 'default' : 'ghost'}
            size="sm"
            onClick={handleDiagnosticLogsClick}
          >
            <Bug className="mr-2 h-4 w-4" />
            Logs
          </Button>
          <Button
            variant={currentPath === '/agent' ? 'default' : 'ghost'}
            size="sm"
