...
namespace DunGen.Tests.Combat
{
    ...
    public class CombatSystemTests
    {
        ...
        public void InitiativeRoll_BreaksTies_DeterministicallyByEntityId()
        {
            ...
            // First participant should consistently be same
            Assert.AreEqual(100, result1[0].entityId);
        }
        ...
        public void DamageResistance_HalvesDamage()
        {
            ...
            int resistedDamage = calc.CalculateWeaponDamage("1d8", 0, resistanceMultiplier);
        ...
        public void DamageVulnerability_DoublesDamage()
        {
            ...
            int vulnerableDamage = calc.CalculateWeaponDamage("1d6", 2, vulnerabilityMultiplier);
